...
void main() {
  ...
  group('Diary Logging E2E Flow Test', () {
    testWidgets('Loads pet diary entries and filters entries by category', (WidgetTester tester) async {
        ...
        MultiBlocProvider(
          providers: [
            ...
            BlocProvider<DiaryBloc>(
              create: (_) => DiaryBloc(repositorySelector: repositorySelector)..add(const LoadDiary()),
            ),
