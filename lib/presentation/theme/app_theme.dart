  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      textTheme: GoogleFonts.interTextTheme().copyWith(
        displayLarge: GoogleFonts.montserrat(fontWeight: FontWeight.bold, fontSize: 48, letterSpacing: -0.02),
        headlineLarge: GoogleFonts.montserrat(fontWeight: FontWeight.bold, fontSize: 32),
        headlineMedium: GoogleFonts.montserrat(fontWeight: FontWeight.w600, fontSize: 24),
        titleLarge: GoogleFonts.montserrat(fontWeight: FontWeight.w600, fontSize: 18),
        bodyLarge: GoogleFonts.inter(fontWeight: FontWeight.normal, fontSize: 18),
        bodyMedium: GoogleFonts.inter(fontWeight: FontWeight.normal, fontSize: 16),
        labelLarge: GoogleFonts.inter(fontWeight: FontWeight.bold, fontSize: 14, letterSpacing: 0.01),
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      textTheme: GoogleFonts.interTextTheme(ThemeData.dark().textTheme).copyWith(
        displayLarge: GoogleFonts.montserrat(fontWeight: FontWeight.bold, fontSize: 48, letterSpacing: -0.02, color: darkOnSurface),
        headlineLarge: GoogleFonts.montserrat(fontWeight: FontWeight.bold, fontSize: 32, color: darkOnSurface),
        headlineMedium: GoogleFonts.montserrat(fontWeight: FontWeight.w600, fontSize: 24, color: darkOnSurface),
        titleLarge: GoogleFonts.montserrat(fontWeight: FontWeight.w600, fontSize: 18, color: darkOnSurface),
        bodyLarge: GoogleFonts.inter(fontWeight: FontWeight.normal, fontSize: 18, color: darkOnSurface),
        bodyMedium: GoogleFonts.inter(fontWeight: FontWeight.normal, fontSize: 16, color: darkOnSurfaceVariant),
        labelLarge: GoogleFonts.inter(fontWeight: FontWeight.bold, fontSize: 14, letterSpacing: 0.01, color: darkOnSurface),
        labelSmall: GoogleFonts.inter(fontWeight: FontWeight.w500, fontSize: 12, color: darkOnSurfaceVariant),
      ),
      cardTheme: CardThemeData(
        color: darkSurface,
        elevation: 0,
